package jp.suntech.s21003.myhellocustomer;
        ...
        public void onClick(View view) {
            ...
            switch (id){
                case R.id.btClick:
                    ...
                    output.setText(inputStr2+"にお住いの"+inputStr1+"さんこんにちは!");
                    break;
                case R.id.btClearN:
                    String inputStr3=input2.getText().toString();
                    output.setText(inputStr3+"にお住いの***さんこんにちは!");
                    break;
                case R.id.btClearL:
                    String inputStr4=input1.getText().toString();
                    output.setText("***にお住いの"+inputStr4+"さんこんにちは!");
